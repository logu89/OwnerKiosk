...
// }}} 
    ...
    public function actionIndex() {
        ...
        switch ($_REQUEST['action']) {
            ...
            case 'generatekey':
                $response = $fn->generateCustomerAccessKey($_POST);
                break;
            case 'updateframe':
                $response = $fn->updateFrame($_POST);
                break;
            case 'getframe':
                $response = $fn->getFrame();
                break;
            case 'generateqrspec':
                $response = $fn->generateQrSpec($_POST);
                break;
            case 'doorcontrol':
                $response = $fn->doorControl($_POST);
                break;
        ...
        if (is_null($response)) {
            $this->_sendResponse(200, sprintf('No items where found for model <b>%s</b>', $_GET['action']));
        } else {
